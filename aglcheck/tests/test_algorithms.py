...
from aglcheck.algorithms import lengthnsubstrings, substrings, \
    longestsubstrings
...
class TestLengthnsubstrings(TestCase):
    ...
    def test_fullpartsingleresult(self):
        s1 = "bc"
        s2 = "abcde"
        ss = lengthnsubstrings(s1=s1, s2=s2, n=2, readingframe=1)
    ...
    def test_readingframe2(self):
        s1 = "cdefgi"
        s2 = "abcdefgh"
        ss = lengthnsubstrings(s1=s1, s2=s2, n=2, readingframe=2)
...
class TestSubstrings(TestCase):
    ...
    def test_result(self):
        s1 = 'bc'
        s2 = 'abcde'
        ss = substrings(s1=s1, s2=s2, readingframe=1)
...
class TestLongestSubstrings(TestCase):
    ...
    def test_singleresult(self):
        s1 = 'bc'
        s2 = 'abcde'
        ss = longestsubstrings(s1=s1, s2=s2, readingframe=1)
        self.assertEqual(ss, ((('bc', [(0, 1)]),)))
